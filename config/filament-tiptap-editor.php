    ...
    */
    'profiles' => [
        'default' => [
            ...
            'bold', 'italic', 'strike', 'underline','fontselect', 'superscript', 'subscript', 'lead', 'small', 'color', 'highlight', 'align-left', 'align-center', 'align-right', '|',
            'link', 'media', 'oembed', 'table', 'grid-builder', 'details', '|', 'code', 'code-block', 'source', 'blocks',
            'fontFamily'
        ],
        'simple' => ['heading', 'hr', 'bullet-list', 'ordered-list', 'checked-list', '|', 'bold', 'italic', 'lead', 'small', '|', 'link', 'media','fontFamily'],
    ...
    */
    ...
    'extensions' => [
        [
            'id' => 'fontFamily',
            'name' => 'fontFamily',
            'button' => 'tools.fontFamily',
            'parser' => \App\TiptapExtensions\FontExtenion::class,
        ],
    ],
