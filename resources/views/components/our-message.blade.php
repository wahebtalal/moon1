<section class="px-6 xl:px-0">
    <div class="my-16 lg:my-20 mx-auto container">
        <div class="flex flex-col items-center justify-center w-full py-5 lg:py-0">
            <h1 class="font-semibold bg-gold py-2 px-8 rounded-full    text-40px">{!! setting('message_name')??'رسالتنا' !!}</h1>
{{--            <hr class="w-24 h-1 bg-gold rounded-full" />--}}
            <div class="m-2"/>
        </div>
        <div class="flex items-center justify-center w-full mt-10 lg:mt-0">
            <div class="w-full lg:w-10/12 relative">
                <div class="flex lg:items-center justify-center w-full">
                    <div class="flex items-start">
                        ...
                        <p class="custom-gray-800 text-lg leading-8 ml-7 lg:mt-12  ">{!! setting('message')!!}</p>
                    </div>
                </div>
